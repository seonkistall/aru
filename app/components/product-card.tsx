...
const useBtn = (saved: boolean): React.CSSProperties => ({ minHeight: "var(--tap-min)", width: "100%", marginTop: 8, border: "1px solid var(--line)", borderRadius: 9, background: saved ? "var(--surface-tint)" : "transparent", color: saved ? "var(--success)" : "var(--ink-soft)", padding: "10px 12px", fontSize: 12.5, fontWeight: 700, cursor: saved ? "default" : "pointer" });
