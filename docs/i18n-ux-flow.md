...
```mermaid
flowchart TD
    A["홈 /<br/>아루 · 촬영→분석→추천"] -->|"내 피부 결, 보러 가기"| B["스캔 /scan<br/>30초 자동촬영"]
    A -->|"카메라 없이 설문만"| C["설문 /survey"]
...
│              과장 없이,                      │
│           너한테 딱 맞는 셋                   │
│    4만원짜리 실패는 그만. 카메라로 피부를…      │
│                                             │
│        촬영 → 분석 → 추천                    │
│         이렇게 진행돼요                       │
│  ① 30초 피부 스캔       ② 보이는 신호만 정직하게│
│  ③ 아침·저녁 루틴과 제품                      │
│                                             │
│        [ 내 피부 결, 보러 가기 → ]            │
│        카메라 없이 설문만 할래요 →             │
...
EN 예: `No exaggeration, / the three picks made for you` · 주석 `Reads in 30 seconds` · CTA `Go see my skin texture`
