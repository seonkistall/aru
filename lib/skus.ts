 ...
 *
 * NOTE: prices/ratings are representative seed values for the MVP, not a live
 * merchant feed. A production integration replaces SKUS with the partner API.
 */
...
export const SKUS: Sku[] = [
  ...
  sku({
    ...
    price: 13500, volume: "150ml", rating: 4.7, reviewCount: 18400,
  ...
  sku({
    ...
    price: 12000, volume: "150ml", rating: 4.6, reviewCount: 9200,
  ...
  sku({
    ...
    price: 15000, volume: "150ml", rating: 4.5, reviewCount: 7600,
  ...
  sku({
    ...
    price: 19000, volume: "250ml", rating: 4.8, reviewCount: 42000,
  ...
  sku({
    ...
    price: 18000, volume: "200ml", rating: 4.7, reviewCount: 31000,
  ...
  sku({
    ...
    price: 16000, volume: "300ml", rating: 4.5, reviewCount: 8800,
  ...
  sku({
    ...
    price: 21000, volume: "100ml", rating: 4.7, reviewCount: 25000,
  ...
  sku({
    ...
    price: 38000, volume: "50ml", rating: 4.6, reviewCount: 6400,
  ...
  sku({
    ...
    price: 22000, volume: "30ml", rating: 4.7, reviewCount: 19000,
  ...
  sku({
    ...
    price: 24000, volume: "50ml", rating: 4.8, reviewCount: 34000,
  ...
  sku({
    ...
    price: 25000, volume: "32ml", rating: 4.5, reviewCount: 12000,
  ...
  sku({
    ...
    price: 29000, volume: "30ml", rating: 4.4, reviewCount: 9800,
  ...
  sku({
    ...
    price: 27000, volume: "80ml", rating: 4.8, reviewCount: 28000,
  ...
  sku({
    ...
    price: 14000, volume: "200ml", rating: 4.6, reviewCount: 15000,
  ...
  sku({
    ...
    price: 24000, volume: "70ml", rating: 4.6, reviewCount: 21000,
  ...
  sku({
    ...
    price: 20000, volume: "50ml", rating: 4.7, reviewCount: 22000,
  ...
  sku({
    ...
    price: 18000, volume: "50ml", rating: 4.7, reviewCount: 30000,
  ...
  sku({
    ...
    price: 17000, volume: "18g", rating: 4.5, reviewCount: 11000,
  ...
  sku({
    ...
    price: 1800, volume: "1매", rating: 4.5, reviewCount: 40000,
    forTypes: ["지성", "복합성", "민감성"], concerns: ["트러블", "붉은기", "유분"],
  ...
  sku({
    ...
    price: 3000, volume: "1매", rating: 4.6, reviewCount: 16000,
  ...
  sku({
    ...
    price: 30000, volume: "25ml", rating: 4.5, reviewCount: 5200,
  ...
  sku({
    ...
    price: 22000, volume: "30ml", rating: 4.4, reviewCount: 6100,
