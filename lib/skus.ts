...
export const SKUS: Sku[] = [
  // ── 클렌저 ──────────────────────────────────────────────
  sku({
    id: "cl1", image: "/products/cl1.jpg", brand: "라운드랩", name: "자작나무 수분 클렌저", category: "클렌저",
  ...
  sku({
    id: "cl3", image: "/products/cl3.jpg", brand: "닥터지", name: "레드 블레미쉬 클리어링 폼", category: "클렌저",
  ...
  // ── 토너 ────────────────────────────────────────────────
  sku({
    id: "tn1", image: "/products/tn1.jpg", brand: "아누아", name: "어성초 77 토너", category: "토너",
  ...
  sku({
    id: "tn2", image: "/products/tn2.jpg", brand: "라운드랩", name: "독도 토너", category: "토너",
  ...
  sku({
    id: "tn3", image: "/products/tn3.jpg", brand: "브링그린", name: "티트리 시카 수딩 토너", category: "토너",
  ...
  // ── 에센스 ──────────────────────────────────────────────
  sku({
    id: "es1", image: "/products/es1.jpg", brand: "코스알엑스", name: "어드밴스드 스네일 96 에센스", category: "에센스",
  ...
  // ── 크림 ────────────────────────────────────────────────
  sku({
    id: "cr1", image: "/products/cr1.jpg", brand: "에스트라", name: "아토베리어 365 크림", category: "크림",
  ...
  sku({
    id: "cr2", image: "/products/cr2.jpg", brand: "일리윤", name: "세라마이드 아토 크림", category: "크림",
  ...
  sku({
    id: "cr3", image: "/products/cr3.jpg", brand: "닥터지", name: "레드 블레미쉬 수분 크림", category: "크림",
  ...
  // ── 선크림 ──────────────────────────────────────────────
  sku({
    id: "su1", image: "/products/su1.jpg", brand: "라운드랩", name: "자작나무 수분 선크림", category: "선크림",
  ...
  sku({
    id: "su2", image: "/products/su2.jpg", brand: "닥터지", name: "그린 마일드 업 선", category: "선크림",
  ...
  // ── 마스크팩 ────────────────────────────────────────────
  sku({
    id: "mk1", image: "/products/mk1.jpg", brand: "메디힐", name: "티트리 카밍 마스크", category: "마스크팩",
  ...
  sku({
    id: "ey2", image: "/products/ey2.jpg", brand: "구달", name: "청귤 비타C 잡티 아이크림", category: "아이크림",
    price: 22000, volume: "30ml",
